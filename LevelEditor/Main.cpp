...
#include <iostream>
#include <conio.h>
#include <windows.h> // for the input
#include <fstream>
...
void SaveLevel(char* pLevel, int levelWidth, int levelHeight);
void DisplayLegend();
...
void SaveLevel(char* pLevel, int levelWidth, int levelHeight)
{
    ...
    {
        levelFile << levelWidth << endl;
        levelFile << levelHeight << endl;
        levelFile.write(pLevel, (long long)levelWidth * (long long)levelHeight);
        if (!levelFile)
        {
